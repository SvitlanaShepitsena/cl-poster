(function () {
    ...
    angular.module('article')
        ...
        .directive('svArticlePad', function (url, svTextAngular) {
            return {
                replace: true,
                templateUrl: 'scripts/article/directives/sv-article-pad.html',
                scope: {
                    body: '='
                },
                link: function ($scope, el, attrs) {
                    ...
                    var articlePad = el.find('#articlePad')[0].classList;
